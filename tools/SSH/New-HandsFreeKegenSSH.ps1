#.DESCRIPTION
# Demos how to generate SSH user public/private key pairs 
# non-interactively, i.e., hands-free.  Similar commands 
# might be added to a user's logon script.
#
#.NOTES
...
# These are just example commands; it's not a script to be run as-is, so exit.
exit

# These commands cannot be run in PowerShell ISE in any case:
...
# TODO: show commands for hands-free ssh-add.exe too.
