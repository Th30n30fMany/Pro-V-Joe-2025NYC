...
#
#  WARNING!  This script sets the default user shell for OpenSSH to CMD.EXE.
#  This is the factory default.  Despite what Microsoft says, this Subsystem
#  does not work correctly if the OpenSSH user shell is other than CMD.EXE.  
#
#.NOTES
...
# Despite what Microsoft says, the above Subsystem does not work correctly if the default shell
# is anything other than CMD.EXE, so overwrite the current default OpenSSH shell:
